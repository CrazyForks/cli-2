 ...
 *   onLoad?: (entry: { key: string, value: string, section: string | null, line: number }) => void,
 * }} [options]
 */
export function loadCliControlEnv(env, {
  ...
  const ns = firstNonEmptyString(nsFromFlag, env.WDL_NS);
  if (ns) {
...
function parseDotEnvSection(line, lineNumber) {
